            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div>
                            <h3 className="font-medium">Wahala</h3>
                            <p className="text-gray-500 text-sm">Pidgin - "Problem or trouble"</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div>
                            <h3 className="font-medium">Omo</h3>
                            <p className="text-gray-500 text-sm">Yoruba - "Child or exclamation"</p>
                        </div>
                        <div className="flex gap-2">
                            <button className="bg-green-100 text-green-800 px-3 py-1 rounded-md text-sm flex items-center gap-1">
                                <i data-feather="check" className="w-4 h-4"></i> Approve
