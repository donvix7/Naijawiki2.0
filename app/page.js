  ...
  useEffect(() => {
    const fetchRecentWords = async () => {
      ...
      try {
        ...
        // Group by day and limit to 5 per day (if createdAt exists)
        const grouped = {};
        words.forEach((word) => {
        ...
        // Flatten groups (most recent first)
    ...
    <div className="flex flex-col min-h-screen justify-center bg-zinc-50 font-sans dark:bg-black">
      ...
      <section className="py-16 container mx-auto px-6">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">No words found this week.</p>
        ) : (
