    ...
    <div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
            ...
            <div className="w-full md:w-auto">
                <a href="/submit-word"
                    className="inline-flex items-center btn-outline bg-primary hover:bg-yellow-600 text-white font-bold py-3 px-6 rounded-full transition-colors">
       ...
       <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        ...
                        <a href="/word-detail " className="text-accent hover:underline">View details</a>
                    </div>
                </div>
            </div>
        ))
