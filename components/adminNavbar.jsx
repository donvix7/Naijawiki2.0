...
const AdminNavbar = () => {
  ...
  return (
    <div className="admin">
      <nav className="bg-[var(--neutral)] shadow-sm">
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo and Brand - Left side */}
            <a href="/admin/" className="flex items-center space-x-3 text-white hover:text-[var(--accent)] transition-colors">
            ...
            <div className="flex items-center">
              ...
              <div className="relative dropdown">
                <button 
                  ...
                  className="flex items-center space-x-2 text-white hover:text-[var(--accent)] transition-colors p-2 rounded-md"
                >
                  <div className="w-8 h-8 bg-[var(--primary)] rounded-full flex items-center justify-center font-semibold text-sm text-white">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200">
                    ...
                    <button
                      ...
                      className="dropdown-item flex items-center w-full px-4 py-2 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors"
                    >
